...
const Card = () => {
  return (
    <div className="group my-10 flex w-full flex-col overflow-hidden rounded-lg border border-stone-700 bg-stone-500 shadow-md">
      <a
      ...
      <div className="mt-4 px-5 pb-5">
        <Link to={""}>
          <h5 className="text-xl tracking-tight text-stone-900">
            Nike Air MX Super 2500 - Red
          </h5>
        </Link>
        <div className="mt-2 mb-5 flex items-center justify-between">
          <p>
            <span className="text-3xl font-bold text-stone-900">$449</span>
          </p>
        </div>
        <div className="flex justify-between flex-col gap-4">
          ...
          <button className="flex items-center justify-center rounded-md border-2 border-stone-900 bg-stone-500 px-5 py-2.5 text-center text-sm font-medium text-stone-900 hover:bg-stone-900 hover:text-stone-300 focus:outline-none focus:ring-4 focus:ring-stone-300 transition-all">
            Quality Check
          </button>
        </div>
      </div>
