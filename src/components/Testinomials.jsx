      ...
      <section className="mt-12">
        <div className="mx-auto w-[90%] lg:w-[80%] xl:w-[90%] 2xl:w-[1400px] py-12">
          <div className="max-w-7xl items-end justify-between sm:flex sm:pe-6 lg:pe-8">
            ...
            <div className="mt-8 flex gap-4 lg:mt-0">
              <button
                ...
                className="rounded-full border border-stone-300 p-3 text-stone-300 transition hover:bg-stone-300 hover:text-stone-900"
              >
                <svg
          ...
          <div className="-mx-6 mt-8 lg:col-span-2 lg:mx-0">
            ...
            >
              <SwiperSlide>
                <blockquote className="flex h-full flex-col mx-8 md:mx-0 justify-between bg-stone-800 p-6 shadow-sm sm:p-8 lg:p-12 border border-stone-500">
                  <div>
